import { Test, Assert, Channel } from '@sinclair/carbon'
...
Test.describe('Channel:Channel', () => {
  ...
  Test.it('Should receive next value then end', async () => {
    ...
    const eof = await channel.receive()
  ...
  Test.it('Should receive next values then end', async () => {
    ...
    const value0 = await channel.receive()
    const value1 = await channel.receive()
    const value2 = await channel.receive()
    const value3 = await channel.receive()
    const eof = await channel.receive()
  ...
  Test.it('Should throw on receive if send error', async () => {
    ...
    const value0 = await channel.receive()
    const value1 = await channel.receive()
    const value2 = await channel.receive().catch((error) => error)
    Assert.isEqual(value0, 0)
    Assert.isEqual(value1, 1)
  ...
  Test.it('Should receive eof for all subsequent reads on an ended channel', async () => {
    ...
    const value0 = await channel.receive()
    const value1 = await channel.receive()
    const eof0 = await channel.receive()
    const eof1 = await channel.receive()
    Assert.isEqual(value0, 0)
    Assert.isEqual(value1, 1)
