import { Channel, Assert, Test } from '@sinclair/carbon'
...
Test.describe('Channel:Select', () => {
  ...
  Test.it('Should receive select from single channel', async () => {
    ...
    channel.send(3)
    channel.end()
    const value0 = await select.receive()
    const value1 = await select.receive()
    const value2 = await select.receive()
    const value3 = await select.receive()
    const eof = await select.receive()
  ...
  Test.it('Should receive select from multiple channels', async () => {
    ...
    const value2 = await select.receive()
    const value3 = await select.receive()
    const value4 = await select.receive()
    const value5 = await select.receive()
    const value6 = await select.receive()
    const value7 = await select.receive()
    const eof = await select.receive()
    Assert.isEqual(value0, 0)
    Assert.isEqual(value1, 1)
    Assert.isEqual(value2, 2)
  ...
  Test.it('Should timeout if one of multiple channels never ends', async () => {
    ...
    await select.receive()
    await select.receive()
    await Assert.shouldTimeout(async () => await select.receive(), { timeout: 100 })
  })
  Test.it('Should throw if single channel errors', async () => {
    ...
    const value0 = await select.receive()
    const value1 = await select.receive()
    const value2 = await select.receive().catch((error) => error)
    Assert.isEqual(value0, 0)
    Assert.isEqual(value1, 1)
