...
declare module 'bun' {
   ...
   *
   */
  export function which(command: string, options?: { PATH?: string; cwd?: string }): string | null
   ...
   */
  // tslint:disable-next-line:unified-signatures
  export function write(destinationPath: PathLike, input: BunFile): Promise<number>
   ...
   */
  export function readableStreamToArrayBuffer(stream: ReadableStream<ArrayBufferView | ArrayBufferLike>): Promise<ArrayBuffer> | ArrayBuffer
   ...
   * ```
   */
  export function readableStreamToFormData(stream: ReadableStream<string | TypedArray | ArrayBufferView>, multipartBoundaryExcludingDashes?: string | TypedArray | ArrayBufferView): Promise<FormData>
   ...
   *
   */
  export function readableStreamToArray<T>(stream: ReadableStream<T>): Promise<T[]> | T[]
   ...
   */
  export const hash: ((data: string | ArrayBufferView | ArrayBuffer | SharedArrayBuffer, seed?: number | bigint) => number | bigint) & Hash
  ...
  export type ImportKind = 'import-statement' | 'require-call' | 'require-resolve' | 'dynamic-import' | 'import-rule' | 'url-token' | 'internal' | 'entry-point'
  ...
  export interface UnixWebSocketServeOptions<WebSocketDataType = undefined> extends GenericServeOptions {
    /**
     * If set, the HTTP server will listen on a unix socket instead of a port.
     * (Cannot be used with hostname+port)
     */
  ...
  export interface TLSWebSocketServeOptions<WebSocketDataType = undefined> extends WebSocketServeOptions<WebSocketDataType>, TLSOptions {
    unix?: never
    tls?: TLSOptions
  }
  export interface UnixTLSWebSocketServeOptions<WebSocketDataType = undefined> extends UnixWebSocketServeOptions<WebSocketDataType>, TLSOptions {
    /**
     * If set, the HTTP server will listen on a unix socket instead of a port.
     * (Cannot be used with hostname+port)
     */
   ...
   */
  // tslint:disable-next-line:unified-signatures
  export function file(path: ArrayBufferLike | Uint8Array, options?: BlobPropertyBag): BunFile
   ...
   */
  // tslint:disable-next-line:unified-signatures
  export function file(fileDescriptor: number, options?: BlobPropertyBag): BunFile
  ...
  type SupportedCryptoAlgorithms = 'blake2b256' | 'md4' | 'md5' | 'ripemd160' | 'sha1' | 'sha224' | 'sha256' | 'sha384' | 'sha512' | 'sha512-256'
  /**
  ...
  type OnResolveCallback = (args: OnResolveArgs) => OnResolveResult | Promise<OnResolveResult | void | undefined | null> | void | undefined | null
   ...
   *
   */
  export function connect<Data = undefined>(options: TCPSocketConnectOptions<Data>): Promise<Socket<Data>>
  export function connect<Data = undefined>(options: UnixSocketOptions<Data>): Promise<Socket<Data>>
   ...
   *
   */
  export function listen<Data = undefined>(options: TCPSocketListenOptions<Data>): TCPSocketListener<Data>
  export function listen<Data = undefined>(options: UnixSocketOptions<Data>): UnixSocketListener<Data>
...
type TypedArray = Uint8Array | Int8Array | Uint8ClampedArray | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array | BigInt64Array | BigUint64Array
...
type NoParamCallback = (err: any | null) => void
// type BufferEncoding =
//   | "buffer"
//   | "utf8"
//   | "utf-8"
